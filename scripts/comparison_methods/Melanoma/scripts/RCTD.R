...
nUMI <- colSums(multipliedMatrix)
names(nUMI) <- colnames(multipliedMatrix)

reference_mela <- Reference(multipliedMatrix, cell_types, nUMI)
...
write.csv(rctd_out, file = "D:/Projects/CARD-master/data/画饼图/Mela/RCTD_output.csv")
