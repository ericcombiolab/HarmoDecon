...
write.csv(st_data@spatial_enrichment$DWLS, paste0('D:/Projects/CARD-master/data/画饼图/Mela/SpatialDWLS_result.csv'))

# my_giotto_object = createGiottoObject(raw_exprs = mela_st_count, spatial_locs = star_st_spatial, instructions = my_instructions)
